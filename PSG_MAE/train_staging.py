...
from data.dataset_staging import (
...
def train_one_fold(fold, train_subjects, test_subjects, args):
    ...
    classifier = Classification_Head(num_classes=5)
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        if epoch % args.val_interval == 0:
            ...
            print("[Fold {fold+1}] Per-class Val Accuracy:")
    ...
    print("[Fold {fold+1}] Per-class Test Accuracy:")
    print_per_class_accuracy(targets, preds)
